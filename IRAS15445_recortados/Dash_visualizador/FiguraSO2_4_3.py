...
path = '/home/marcela/Tesis Marcela/IRAS15445_recortados/I15445.mstransform_cube_contsub_SO2_4_3.fits'
path_cont = '/home/marcela/Tesis Marcela/IRAS15445_recortados/All_spw_continuum_temp.fits'

def moment0(path):
    cube_prueba = SpectralCube.read(path)
    
    cube_cut = cube_prueba[120:220,230:290,225:280]
...
ax3.vlines(vsys, 0, max(out.best_fit),color='green',label='Vsys = '+str(vsys))
...
output_filename = 'SO2_4_3.png'  # Cambia la extensión si prefieres otro formato como .pdf, .svg, etc.
