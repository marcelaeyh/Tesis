...
plt.yticks(ticks=np.arange(len(y_tick_labels))*9, labels=np.round(y_tick_labels, 2),fontsize=12)
...
plt.savefig('/home/marcela/Tesis Marcela/IRAS15445_recortados/Vistalateral.png',dpi=300)
