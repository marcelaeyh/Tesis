...
cbar1.set_label('[Jy/Beam . km/s]', fontsize=13)
...
ax1.set_xlabel('J2000 RA offset [arcsec]',fontsize=13)
ax1.set_ylabel('J2000 DEC offset [arcsec]',fontsize=13)
...
ax1.hlines(5,10,ang[0]/delta+10,color='k')
ax1.text(10,2,'500 UA',fontsize=11)

# Beam
beam_ellipse = Ellipse(
    (55, 5), width=beam.minor.value/delta*3600, height=beam.major.value/delta*3600, angle=beam.pa.value,
...
ax2.set_yticklabels(np.round(np.linspace(y.min()+0.01, y.max(), 7), 2),fontsize=12)
ax2.set_xlabel('J2000 RA offset [arcsec]',fontsize=13)
ax2.set_ylabel('J2000 DEC offset [arcsec]',fontsize=13)

# Añadir la barra de colores
cbar2 = plt.colorbar(im2, ax=ax2)
cbar2.set_label('[km/s]', fontsize=13)
...
ax2.hlines(5,10,ang[0]/delta+10,color='k')
ax2.text(10,2,'500 UA',fontsize=11)
...
#plt.savefig('13CO_moment2_44kpc.png', dpi=300, bbox_inches='tight')  # 'dpi=300' aumenta la resolución
...
ax3.set_title('13CO mean line emission', fontsize=12)
...
output_filename = '13CO_44kpc.png'  
