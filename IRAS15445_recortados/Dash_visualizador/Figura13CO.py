...
plt.savefig('13CO_moment0', dpi=300, bbox_inches='tight')  # 'dpi=300' aumenta la resolución
...
plt.savefig('13CO_moment2', dpi=300, bbox_inches='tight')  # 'dpi=300' aumenta la resolución
...
output_filename = '13CO_mean_emission.png'  # Cambia la extensión si prefieres otro formato como .pdf, .svg, etc.
